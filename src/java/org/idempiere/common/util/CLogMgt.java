...
public class CLogMgt
{
	...
	public static synchronized void initialize(boolean isClient)
	{
		...
		{			
			try
			{	//	Load Logging config from org.idempiere.common.util.*properties
		...
		catch (Exception e)
		{
			...
			java.lang.ClassNotFoundException: org.idempiere.common.util.CLogConsole
				...
				at org.idempiere.common.util.CLogMgt.initialize(CLogMgt.java:67)
				at org.idempiere.Adempiere.startup(Adempiere.java:389)
				at org.idempiere.Adempiere.main(Adempiere.java:500)
