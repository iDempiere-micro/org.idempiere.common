...
public class CConnection implements Serializable, Cloneable, ICConnection
{
	...
	/** DB User password    */
	private String 		m_db_pwd = "idempiere";
	...
	public AdempiereDatabase getDatabase ()
	{
		...
		if (m_db == null)
		{
			...
			{
				System.out.println( "EE1:" + e.toString() );
				e.printStackTrace();
				log.severe(e.toString ());
			}
		}
	...
	public Connection getConnection (boolean autoCommit, int transactionIsolation)
	{
		...
		{
			System.out.println( "E2:" + ule.toString() );
			ule.printStackTrace();
		...
		{
			System.out.println( "E3:" + ex.toString() );
			ex.printStackTrace();
		...
		{
			System.out.println( "E4:" + ex.toString() );
			ex.printStackTrace();
